package jp.cellfusion.sound 
{
	...
	{
		static private var _instance:SoundManager2;
		...
		static public function get instance():SoundManager2
		{
			if (!_instance) _instance = new SoundManager2(new SingletonEnforcer());
			return _instance;
		}

		public function SoundManager2(se:SingletonEnforcer) 
		{
		 ...
		 * 
		 */
		public function unmute(fade:Boolean = false, seconds:Number = 1, easing:Function = null):void 
		{
			if (fade) {
				easing = easing || Linear.easeNone;
				fadeStart(1, seconds, easing);
			} else {
				volume = 1;
			}
		}
